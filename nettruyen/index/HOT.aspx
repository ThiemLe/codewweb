<%@ Page Title="" Language="C#" MasterPageFile="~/index/home.Master" AutoEventWireup="true" CodeBehind="HOT.aspx.cs" Inherits="nettruyen.index.HOT" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../style/StyleHOT.css" rel="stylesheet" />
</asp:Content>
    ...
    <div class="contact" style="background-color: #c1bbb7; margin-top: -30px; ">
        <div style="width: 1024px;margin: 0px auto;background-color: #e6dbdb">
			...
			<div style="width: 1024px;height: 250px;">
				...
				<a href="#"><img class="photo" stt="0" src="../img/avt3.jpg" alt=""></a>
				<a href="#"><img class="photo" stt="1" src="../img/avt2.jpg" style="display: none;" alt=""></a>
				<a href="#"><img class="photo" stt="2" src="../img/avt1.jpg" style="display: none;" alt=""></a>
				</div>
				...
				<a href="#"><img class="photo2" stt="0" src="../img/avt5.jpg" alt=""></a>
				<a href="#"><img class="photo2" stt="1" src="../img/avt4.jpg" style="display: none;" alt=""></a>
				...
				<a href="#"><img class="photo3" stt="0" src="../img/avt9.jpg" alt=""></a>
				<a href="#"><img class="photo3" stt="1" src="../img/avt8.jpg" style="display: none;" alt=""></a>
				<a href="#"><img class="photo3" stt="2" src="../img/avt7.jpg" style="display: none;" alt=""></a>
			        </div>
				</li>
				<li>
					<div class="slider4">
				...
				<a href="#"><img class="photo4" stt="0" src="../img/avt12.jpg" alt=""></a>
				<a href="#"><img class="photo4" stt="1" src="../img/avt11.jpg" style="display: none;" alt=""></a>
				<a href="#"><img class="photo4" stt="2" src="../img/avt10.jpg" style="display: none;" alt=""></a>
			        </div>
				</li>
				<li>
					<div class="slider5">
				...
				<a href="#"><img class="photo5" stt="0" src="../img/avt14.jpg" alt=""></a>
				<a href="#"><img class="photo5" stt="1" src="../img/avt9.jpg" style="display: none;" alt=""></a>
		...
		<div class="row" style="position: relative;">
			...
			<h1 class="tdecu2">Truyện Hot Nhất ></h1>
			<div class="items" >
					<ul class="tdecu-ul2" >
						<li >
							<div class="image" style="position: relative;">
                                <a href="thongtin.aspx">
                                    <img class="ig" id="ig" src="../img/avt19.jpg" alt="">
                                </a>
			...
			<div class="items" >
					<ul class="tdecu-ul2">
						<li>
							<div class="image" style="position: relative;">
								<a href="#"><img class="ig" src="../img/anh2.jpg" alt=""></a>
								<span class="icon icon-hot">	
								</span>
							</div>							
